  ...
  const steps = [
    {
      ...
      title: t("cta.step1.title"),
      desc: t("cta.step1.desc"),
    },
    {
      icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: t("cta.step2.title"),
      desc: t("cta.step2.desc"),
    },
    {
      icon: (
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      title: t("cta.step3.title"),
      desc: t("cta.step3.desc"),
    },
  ];
  ...
  return (
    <section className="bg-[#f5f5f7] py-14 md:py-20 px-4 md:px-6 font-sans text-center">
      <div className="max-w-5xl mx-auto">
        <AnimatedSection>
          <h2 className="text-2xl md:text-4xl font-normal text-black mb-10 md:mb-16 tracking-tight" dangerouslySetInnerHTML={{ __html: t("cta.heading").replace(/<bold>/g, '<span class="font-bold">').replace(/<\/bold>/g, '</span>') }} />
        </AnimatedSection>
